# Artificial Data provider for the Aircraft_44 implementation
...
keys = [
    # those are the keys for the Aircraft_44, which are declared in the dictionary on OpenMCT side
